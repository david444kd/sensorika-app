    ...
    <Card>
      ...
      <CardContent>
        <div className="space-y-3">
          <Label>Оценка (0 — низкий, 10 — высокий)</Label>
              ...
              return (
                <div className="px-2">
                  <Slider
                    ...
                    className="w-full"
                  />
                  <div className="mt-2 text-sm">Текущее значение: <strong>{Array.isArray(field.value) ? field.value[0] : field.value}</strong></div>
                </div>
              )
            }}
          />
